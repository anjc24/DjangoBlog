...
def detail(request, pid):
    datau = None
    if request.user.is_authenticated :
        datau = User_Details.objects.filter(usr=request.user).first()
    ...
    p = {"allcat": All_category(), 'listcat': All_category(), "userdetail": datau, 'post': post_data,"recent":recent, "popular":popular, 'publisher':publisher, "tags": tags(), "like":d, "likecount":likecount, "commentcount":commentcount, "comments":comments ,"previous":previous, "next":next}
...
def category(request, cid):
    ...
    recent, popular = recent_and_popular()
    p = {"allcat": All_category(), 'listcat': All_category(), "userdetail": data,  'post':page_obj , 'pg':pg ,'category': cname, "tags": tags(), "recent":recent, "popular":popular}
...
def tag(request, tid):
    ...
    recent, popular = recent_and_popular()
    p = {"allcat": All_category(), 'listcat': All_category(), "recent":recent, "popular":popular, "userdetail": data,  'post': page_obj, 'pg': pg, 'tagname': tname, "tags": tags()}
    return render(request, 'posts/category.html', p)
...
def CreatePost(request):
    ...
    if request.user.is_authenticated :
        data = User_Details.objects.filter(usr=request.user).first()
    p = {"allcat": All_category(), 'listcat': All_category(), "userdetail": data,}
...
def SearchPost(request):
    ...
    page_obj = pg.get_page(page_number)
    recent, popular = recent_and_popular()
    p = {"allcat": All_category(), 'listcat': All_category(), "userdetail": data, 'post':page_obj , 'pg':pg , "tags": tags(), "recent":recent, "popular":popular}
...
def UpdateBlog(request, bid):
    ...
    dic = {"allcat": All_category(), 'listcat': All_category(), "userdetail": data,  "blogdetails": blog, "tags" : s}
...
def UpdateProfile(request):
    ...
    d = {"allcat": All_category(), "userdetail": data,  'listcat': All_category(), "userdata":data}
...
def PasswordReset(request):
     ...
     dic = {'error': error, 'succ':succ, "userdetail": data, 'listcat': All_category(), }
...
def userposts(request, uid):
    ...
    page_obj = pg.get_page(page_number)
    recent, popular = recent_and_popular()
    p = {"allcat": All_category(), 'listcat': All_category(), "recent":recent, "popular":popular, "userdetail": data,  'post':page_obj , 'pg':pg ,"tags": tags()}
    return render(request, 'posts/category.html', p)
...
def contact(request):
    ...
    if request.user.is_authenticated :
        data = User_Details.objects.filter(usr=request.user).first()
    p={ 'listcat': All_category(), "userdetail": data}
    return render(request, 'posts/contact.html',p)
...
def about(request):
    ...
    if request.user.is_authenticated :
        data = User_Details.objects.filter(usr=request.user).first()
    p = {'listcat': All_category(), "userdetail": data}
    return render(request, 'posts/about.html',p)